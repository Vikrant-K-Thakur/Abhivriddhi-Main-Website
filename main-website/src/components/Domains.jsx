...
const domains = [
  {
    name: 'Curation',
    team: 'Team Curation',
    tag: 'Writing & Communication',
    desc: 'Crafting the written voice of the organization through content creation, storytelling, and communication across emails, WhatsApp, social media, and organizational initiatives.',
    color: '#b8cc8a',
    rotate: '-2.5deg',
  },
  {
    name: 'Corporate Relations',
    team: 'Team Corporate Relations',
    tag: 'Partnerships & Sponsorships',
    desc: "Building strategic partnerships, sponsorships, and industry collaborations that strengthen the organization's network, credibility, and professional opportunities.",
    color: '#8ab4cc',
    rotate: '1.8deg',
  },
  {
    name: 'Outreach',
    team: 'Team Outreach',
    tag: 'Publicity & Engagement',
    desc: "Driving the organization's visibility through publicity, branding, and social media strategies that strengthen engagement, reach, and community presence.",
    color: '#cc9e8a',
    rotate: '-1.2deg',
  },
  {
    ...
    desc: 'Ensuring the smooth execution of initiatives through efficient operations, financial management, coordination, and structured planning across all activities.',
    color: '#b08acc',
    rotate: '2.2deg',
  },
  {
    name: 'Branding',
    team: 'Team Branding',
    tag: 'Visual Identity & Media',
    desc: 'Shaping the visual identity of the organization through design, multimedia, and technical creativity to deliver consistent, impactful, and professional brand experiences.',
    color: '#ccb88a',
    rotate: '-1.8deg',
  },
];
