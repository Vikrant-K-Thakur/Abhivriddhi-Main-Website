      ...
      <div className="phil-left">
        <div className="phil-left-inner">
          ...
          <p className="phil-sub">
            A structured pathway designed to guide students through every stage of their growth.
From gaining early clarity and building essential skills to applying them in real-world environments, each experience contributes to developing confident, industry-ready professionals.
