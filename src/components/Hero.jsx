  ...
  return (
    <section id="hero">
      ...
      <div className="hero-left">
        ...
        <p className="hero-desc">The Student Training &amp; Development Committee — empowering students through skill-building workshops, mentoring sessions, and hands-on experiences. Bridging faculty and students to foster personal and professional growth.</p>
