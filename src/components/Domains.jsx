...
const domains = [
  {
    name: 'Cooperate Relations',
    team: 'Team Public Relations',
    tag: 'PR & Communications',
    desc: 'Corporate Relations focuses on building and nurturing strategic partnerships with industry leaders and organizations. It plays a key role in securing sponsorships, collaborations, and professional opportunities. The domain works to create mutually beneficial relationships that enhance the organization’s reach and credibility. By connecting with the corporate world, it brings valuable exposure, resources, and growth opportunities.',
    color: '#b8cc8a',
    rotate: '-2.5deg',
  },
  {
    ...
    team: 'Team Technical',
    tag: 'Tech & Innovation',
    desc: 'Branding defines and elevates the visual identity of the committee, shaping how it is perceived across all platforms. It brings together Multimedia, Design and Technical expertise to create cohesive and impactful visuals. From graphics and motion content to digital interfaces, the domain ensures consistency in every touchpoint. It plays a key role in building a strong, recognizable, and professional visual reputation.',
    color: '#8ab4cc',
    rotate: '1.8deg',
  },
  {
    ...
    team: 'Team Design',
    tag: 'Creative & Visual',
    desc: 'The Outreach domain drives Abhivriddhi’s visibility and engagement through publicity, branding, and social media presence. It focuses on creating impactful communication strategies that connect with students, expand reach, and strengthen the committee’s identity.',
    color: '#cc9e8a',
    rotate: '-1.2deg',
  },
  {
    ...
    desc: 'Curation shapes the overall experience by ideating, structuring, and refining the organization’s initiatives and content direction. It ensures that every event and communication aligns with the central vision and maintains a consistent standard of quality. Through its Content domain the voice of the committee it drives communication across emails, WhatsApp, and social media platforms. The domain brings together creativity and clarity to deliver cohesive, engaging, and impactful messaging.',
    color: '#b08acc',
    rotate: '2.2deg',
  },
  {
    ...
    desc: 'The Management domain ensures the smooth execution of Abhivriddhi’s initiatives through efficient finance handling and operational planning. It focuses on resource management, coordination, and structured processes that keep every event and activity running seamlessly.',
    color: '#ccb88a',
    rotate: '-1.8deg',
  },
];
