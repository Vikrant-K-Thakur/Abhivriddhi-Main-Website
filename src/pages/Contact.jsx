...
const styles = `
  ...
  .c-hero-title em { color: var(--accent); font-style: italic; }
  .c-char {
...
export default function Contact() {
  ...
  return (
    <div className="c-root">
      ...
      <button className={`c-fab ${showFab ? 'on' : ''}`} onClick={() => formRef.current?.scrollIntoView({ behavior: 'smooth', block: 'start' })}>
