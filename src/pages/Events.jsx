...
export default function Events() {
  ...
  const featuredEvents = [
    ...
    },
    {
      ...
      description: "Brand You is a comprehensive personal branding workshop that helps students discover their unique value proposition, build their online presence, and create a compelling professional identity that resonates with employers and peers.",
    ...
    },
    {
      ...
      description: "Avirbhav is Abhivriddhi's signature annual event that brings together students, industry leaders, and innovators for a celebration of growth, learning, and transformation. Experience keynote sessions, workshops, competitions, and networking opportunities all under one roof.",
