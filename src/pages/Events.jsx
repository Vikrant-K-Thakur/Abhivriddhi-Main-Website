...
export default function Events() {
  ...
  const featuredEvents = [
    {
      title: "E.D.G.E",
      highlight: "Bridging ambition with opportunity through industry interaction and practical exposure.",
      description: "EDGE is Abhivriddhi's flagship experience, designed to bring students closer to the realities of the professional world. Structured around core stages of the hiring process — technical assessments, group discussions, and personal interviews — it offers students a closer look at real-world evaluation dynamics.",
      tags: ["Industry Interaction", "Technical Assessment", "Group Discussion", "Personal Interview"],
      ctaText: "Explore E.D.G.E",
    },
    {
      title: "Engineering Unplugged",
      highlight: "An early-stage intervention helping first-year students navigate engineering with clarity and intent.",
      description: "Engineering Unplugged (EU) addresses the uncertainty that often comes with starting out, offering a broader perspective on what an engineering journey can lead to. Structured into panel discussions and speaker-led experiences featuring individuals who began with engineering but carved paths in diverse fields.",
      tags: ["Panel Discussion", "Speaker Sessions", "First Year", "Clarity"],
      ctaText: "Explore Engineering Unplugged",
    },
    {
      title: "EATON",
      highlight: "A collaborative experience focused on strengthening interpersonal and professional skills.",
      description: "EATON is developed in partnership with Eaton, emphasizing communication, teamwork, and adaptability in real-world environments. Delivered in a hybrid format, the program combines structured sessions with interactive activities that encourage participation and practical learning.",
      tags: ["Teamwork", "Communication", "Hybrid Format", "Soft Skills"],
      ctaText: "Explore EATON",
    },
    {
      title: "Aavirbhav",
      highlight: "Promoting emotional well-being among first-year students as they begin their college journey.",
      description: "Aavirbhav is an initiative focused on mental health awareness while encouraging openness and self-reflection. Conducted through short, interactive classroom sessions, students are guided to recognize stress, build resilience, and approach challenges with a healthier mindset.",
      tags: ["Mental Health", "Well-being", "Resilience", "Self-Reflection"],
      ctaText: "Explore Aavirbhav",
    },
    {
      title: "Brand You",
      highlight: "Helping students understand and build their personal brand through self-awareness and skill development.",
      description: "The Brand You Workshop was designed to help students identify individual strengths, values, and unique qualities while enhancing communication, teamwork, and leadership abilities. It instills a growth mindset, enabling participants to align their personal identity with their academic and career aspirations.",
      tags: ["Personal Branding", "Self-Awareness", "Leadership", "Growth Mindset"],
